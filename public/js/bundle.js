...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2lkZGhhcnRoc3NiIiwiYSI6ImNrb2lsajFwYTAwbW0ycHFmbXRjbHhsdWQifQ.FP1MhvKiPvLzIGgFFeRxQg'; //   const locations = JSON.parse(
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updatePassword' : 'http://127.0.0.1:3000/api/v1/users/updateMyData';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51IteTDSJbdGvqUEHGPUcBiqDhmAf9zXodmwhPWfhtpCPqwAtJtl0WoTG4AKfZ5Ft3nFbAPnxmCx102HxuCFijV0P00vtoIQ3aa');
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, review, rating) {
    var tour, url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " review created Successfully"));
            }
...
var reviewBtn = document.querySelector('.btn--review');
var reviewSave = document.querySelector('.review-save');
var closeReview = document.querySelector('.close');
console.log('Just Do It'); // DELEGATION
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--green').textContent = 'Updating...'; // guard clause
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //const  tourId  = e.target.dataset.tourId
...
if (reviewSave) {
  reviewSave.addEventListener("click", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 5;
              return (0, _review.createReview)(tourId, review, rating);
